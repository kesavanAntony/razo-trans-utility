...
const RechargeStatement = () => {
  return(
    <div>
    <Navbar expand="lg" className="bg-body-tertiary">
   <Container>
     <Navbar.Brand href="#home" className='fw-bold h3'>Recharge Statement</Navbar.Brand>
   </Container>
 </Navbar>
     ...
     <Container>
       ...
       <Row>
        <Col md={3} sm={12} className="text-center p-2 align-center">
            ...
            <Col md={3} sm={12} className="text-center p-2 align-center">
              <div> <label className="p-2 h6">Biller</label></div>
             <div><select className="rounded fw-medium h-30 p-1 border-2">
     ...
     <Col>
       <div className="shadow p-3 mb-5 bg-white rounded">
         <div className="fw-bold text-light bg-black p-2 rounded d-flex flex-row justify-content-between ">
           <h5 className="align-center">Recharge Statement</h5>
...
export default RechargeStatement
