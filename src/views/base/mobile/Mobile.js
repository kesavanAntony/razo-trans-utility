           ...
           <div className="fw-bold text-light bg-black p-2  rounded-2">
            ...
            onSubmit={handleSubmit}>
              <div className="mb-3">
                ...
                <Form.Select aria-label="Default select example"  name='circle' required id="validationCustom01" onChange={onHandle} value={value.circle}>
                  <option className='text-secondary'disabled>Select Circle</option>
                  <option>Assam</option>
                  <option>Bihar</option>
              ...
              <div className="mb-3">
                ...
                <Form.Select aria-label="Default select example" name='operator'  id="validationCustom02" onChange={onHandle} value={value.operator}>
                  <option className='text-secondary' disabled>Select Operator</option>
              ...
              <Form.Group className="mb-3" >
                ...
                <Form.Control type="number" placeholder="Enter mobile amount" name='amount'  onChange={onHandle} value={value.amount}/>
